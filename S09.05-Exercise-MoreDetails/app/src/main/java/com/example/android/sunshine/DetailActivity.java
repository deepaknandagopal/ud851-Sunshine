...
//  Completed (20) Create a constant int to identify our loader used in DetailActivity
    private static final int DETAILS_LOADER = 589;
...
//      Completed (13) Find each of the TextViews by ID
        ...
        mWeatherHigh = (TextView) findViewById(R.id.tv_display_highTemp);
        mWeatherLow = (TextView) findViewById(R.id.tv_display_lowTemp);
